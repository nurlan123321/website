...
// Authenticate Login and Password
...
router.post('/login', passport.authenticate('local', { successRedirect: '/', failureRedirect: '/users/login', failureFlash: "Недостающие учетные данные" }),
 function(req, res){
   res.redirect('/')
 });
